#!/usr/bin/env python3
"""Create proper English message files for all 43 restored tools with correct keys"""
import os, json
...
def create_messages():
    for tool, en_msgs in MESSAGES.items():
        for loc in LOCALES:
...
create_messages()
print('\nDone! Created proper English message files for all 43 tools.')