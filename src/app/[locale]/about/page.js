...
import enMsgs from '../../../messages/en/about.json';
import esMsgs from '../../../messages/es/about.json';
import zhMsgs from '../../../messages/zh/about.json';
import koMsgs from '../../../messages/ko/about.json';
import ptMsgs from '../../../messages/pt/about.json';
...
export default function AboutPage() {
  ...
  const changeLang = (l) => { window.location.href = '/' + l + '/about'; };
