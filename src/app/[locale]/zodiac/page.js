...
import enMsgs from '../../../messages/en/zodiac.json';
import esMsgs from '../../../messages/es/zodiac.json';
import zhMsgs from '../../../messages/zh/zodiac.json';
import koMsgs from '../../../messages/ko/zodiac.json';
import ptMsgs from '../../../messages/pt/zodiac.json';
...
export default function ZodiacPage() {
  ...
  const changeLang = (l) => { window.location.href = '/' + l + '/zodiac'; };
