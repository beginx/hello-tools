...
import enMsgs from '../../../messages/en/base64.json';
import esMsgs from '../../../messages/es/base64.json';
import zhMsgs from '../../../messages/zh/base64.json';
import koMsgs from '../../../messages/ko/base64.json';
import ptMsgs from '../../../messages/pt/base64.json';
...
export default function Base64Page() {
  ...
  const changeLang = (l) => { window.location.href = '/' + l + '/base64'; };
