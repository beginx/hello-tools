...
import enMsgs from '../../../messages/en/urlcode.json';
import esMsgs from '../../../messages/es/urlcode.json';
import zhMsgs from '../../../messages/zh/urlcode.json';
import koMsgs from '../../../messages/ko/urlcode.json';
import ptMsgs from '../../../messages/pt/urlcode.json';
const pageMsgs = { en: enMsgs, es: esMsgs, zh: zhMsgs, ko: koMsgs, pt: ptMsgs };


export default function UrlcodePage() {
  const params = useParams();
  const locale = params?.locale || 'en';
  const t = (k) => (pageMsgs[locale] || pageMsgs.en)[k] || k;
  const changeLang = (l) => { window.location.href = '/' + l + '/urlcode'; };
