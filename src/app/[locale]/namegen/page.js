...
import enMsgs from '../../../messages/en/namegen.json';
import esMsgs from '../../../messages/es/namegen.json';
import zhMsgs from '../../../messages/zh/namegen.json';
import koMsgs from '../../../messages/ko/namegen.json';
import ptMsgs from '../../../messages/pt/namegen.json';
...
export default function NamegenPage() {
  ...
  const changeLang = (l) => { window.location.href = '/' + l + '/namegen'; };
